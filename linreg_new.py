...
for it in its:
    ...
    for i, alpha in enumerate(alphas):
        ...
        print('Our Model:')
        print('RMSE: ' + str(np.sqrt(mean_squared_error(np.dot(validData, thetas), y))))
        ...
        """
                ...
                print('SKLearn:')
                print('MSE: ' + str(np.sqrt(mean_squared_error(np.dot(validData, clf.coef_), y))))
                print('MAE: ' + str(calcMAE(validData, y, clf.coef_, m)))
                print()
        """
        thetasNE = normalEquation(trainData, trainTarget)
        print('Normal Equation:')
        print('MSE: ' + str(np.sqrt(mean_squared_error(np.dot(validData, thetasNE), y))))
